...
def get_label_list():
    ...
    return (classes[page_model_dict[session['name']].main_img], classes[page_model_dict[session['name']].compare_img_1], classes[page_model_dict[session['name']].compare_img_2])
